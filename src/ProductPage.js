                ...
                return <div className="attribute-name" key={key}>
                    ...
                    <div className="attribute-text">
                        {attribute.items.map((item) => {
                            return <div className='attribute-text-item' key={item.id} onClick={() => this.changeAttribute(item)}>{item.displayValue}</div>
                        })}
                    </div>
                </div>
            ...
            <div className='container'>
                ...
                <div className='infoAndActionColumn'>
                    ...
                    <div className="attribute-name">
                        PRICE: <br />
                        <GetPrice singleProduct={this.props.selectedProduct} currencySymbol={this.props.activeCurrencySymbol} />
                    </div>
